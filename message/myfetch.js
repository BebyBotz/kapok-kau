...
const exif = {"sticker-pack-id": "com.zeroyt7.tech", "sticker-pack-name": pack, "sticker-pack-publisher": auth, "android-app-store-link": "https://play.google.com/store/apps/details?id=com.termux", "ios-app-store-link": "https://itunes.apple.com/app/sticker-maker-studio/id1443326857"}
...
exports.modStick = (media, zeroyt7, zero, from) => {
out = getRandom('.webp')
try {
console.log(media)
spawn('webpmux', ['-set','exif', './sticker/data.exif', media, '-o', out])
.on('exit', () => {
zeroyt7.sendMessage(from, fs.readFileSync(out), 'stickerMessage', {quoted: zero})
fs.unlinkSync(out)
fs.unlinkSync(media)
})
} catch (e) {
console.log(e)
zeroyt7.sendMessage(from, 'Terjadi keslahan', 'conversation', { quoted: zero })
fs.unlinkSync(media)
}
}